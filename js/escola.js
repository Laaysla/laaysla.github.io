document.addEventListener('DOMContentLoaded', function () {
    ...
    const dadosProdutos = {
        bolsas: [
            ...
            { nome: 'Bolsa Escolar Verde', preco: 60.00, imagem: 'img/bolsa verde.png' },
            { nome: 'Bolsa Escolar Preta', preco: 80.00, imagem: 'img/bolsa preta.png' },
            { nome: 'Mochila de Rodinhas Preta', preco: 100.00, imagem: 'img/rodinhas.png' }
        ],
        cadernos: [
            { nome: 'Caderno Universitário 10 matérias', preco: 15.00, imagem: 'img/caderno 10.png' },
            { nome: 'Caderno Universitário 20 matérias', preco: 25.00, imagem:  'img/caderno 20.webp'  },
            { nome: 'Caderno de Espiral 96 folhas', preco: 12.00, imagem: 'img/caderno espiral.webp' },
        ],
        canetas: [
        ...
        papelaria: [
            ...
            { nome: 'Cartolina Pacote com 20 folhas', preco: 8.00,  imagem: 'img/cartolina 20.jpg'   },
        ...
        agendas: [
            { nome: 'Agenda 2024', preco: 20.00, imagem: 'img/agenda 2024.webp' },
            { nome: 'Agenda Personalizada', preco: 25.00, imagem: 'img/agenda p.webp' }
        ],
        ficharios: [
        ...
        papelariaad: [
            { nome: 'Papel Kraft', preco: 8.50,  imagem: 'img/papel k.webp' },
        ...
        cadernoad: [
            { nome: 'Caderno de Desenho', preco: 10.50,  imagem: 'img/caderno d.png' },
            { nome: 'Caderno Pautado', preco: 10.50,  imagem: 'img/caderno p.png' },
            { nome: 'Caderno Quadriculado', preco: 10.50,  imagem: 'img/caderno q.png' },
        ],
        canetases: [
            { nome: 'Caneta Nanquim', preco: 10.80,  imagem: 'img/caneta n.png' },
            { nome: 'Caneta Brush Pen (24 cores)', preco: 15.50,  imagem: 'img/caneta b.png' },
            { nome: 'Caneta Ponta Fina (10 cores)', preco: 10.50,  imagem: 'img/caneta f.png' },
        ],
        Fitases: [
